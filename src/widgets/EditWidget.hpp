...
class Raymarcher;
/**
 * @brief Allows editing, compiling, previewing and saving of SDF function
 * source code.
 *
 * An edit widget serves for prototyping and editing SDF source codes.
 * The source code can be compiled and associated window with scene's preview is
 * opened.
 */
...
protected:
  ...
  auto CreateRenderWidget(std::shared_ptr<raymarcher::Raymarcher> rm)
