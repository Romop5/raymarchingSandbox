...
auto BVHGenerator::GenerateCluster(glm::vec3 pos, float deviation, size_t count) -> Scene
{
    Scene scene;
...
auto BVHGenerator::GenerateClusteredScene(size_t clusters, float dev, BoundingBox area) -> Scene
{
